...
.CODE
CopyScreenData PROC      ; SourceData, DestinationData, BufferLengthLength   [Position][Length][Data][Position][Length][Data]
	push ebp 
	mov  ebp, esp
	sub  esp, 20h

	mov  ebx, dword ptr [ebp + 10h]      ;BufferLengthLength
